...
wget https://dist.torproject.org/torbrowser/7.5a6/tor-browser-linux64-7.5a6_en-US.tar.xz
tar -xvf tor-browser-linux64-7.5a6_en-US.tar.xz
# clean up
rm tor-browser-linux64-7.5a6_en-US.tar.xz
